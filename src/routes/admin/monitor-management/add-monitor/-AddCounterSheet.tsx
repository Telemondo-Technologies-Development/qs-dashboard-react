...
export default function AddCounterSheet() {
  const { showAddCounterSheet, toggleShowAddCounterSheet } =
    useMonitorManagementStore();

  return (
    <>
      <div
        className={`absolute transition-all h-full top-0 py-8 px-6 bg-main_extra z-50 w-[50%] ${showAddCounterSheet ? "right-0" : "-right-[50%]"} text-main_primary`}
      >
