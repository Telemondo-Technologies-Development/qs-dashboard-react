...
function KioskManagement() {
  const { counterTypes, toggleCounterTypeActionDialog: toggleEditCounterTypeDialog, counterTypeActionType } =
  ...
  const Admin = (
    <div className="flex flex-col flex-1 p-8 overflow-y-auto transition-all gap-7">
      ...
      <div className="flex justify-end gap-3">
        ...
        <button className="px-6 py-1 font-medium text-white rounded-sm bg-main_primary">
          Add Category
        </button>
      </div>
        ...
        {counterTypes.map((counterType) => {
          return (
            ...
            >
              ...
              <button
                onClick={() => toggleEditCounterTypeDialog()}
